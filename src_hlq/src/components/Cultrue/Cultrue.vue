<template>
	<div id="cultrueTest">
		...
		<div class="culTest">
			<div class="intro">
				<div class="logo">
					...
					<template v-else>
						<img src="../../../static/images/Cultrue/logoo.png" />
					</template>
				</div>
				<div class="nameIntro">{{userNickName}}</div>
				<div class="rechoose">
					<div class="city" @click.stop="chosecity()">
						<div>高考省份</div>
					...
					<div class="class" @click.stop="choseclassWay()">
						<div>文理科</div>
			...
			<div class="choose">
				...
				<template>
					<div class="testResultloding" @click="starTest" v-if="startAjax">
					...
					<div class="testResult" @click="starTest" v-else>
						测算
					</div>
				</template>
		...
		<mt-popup v-model="popuProv" position="bottom" class="mint-pop-province" :closeOnClickModal="false" pop-transition='popup-fade'>
			<mt-picker :slots="cityslots" @change="cityValuesChange" valueKey="text" :showToolbar='true'>
				<span class="mint-datetime-action mint-datetime-cancel" @click="provinceCancle()">取消</span>
				<span class="mint-datetime-action mint-datetime-confirm" @click="provinceConfirm()">确定</span>
			</mt-picker>
		</mt-popup>
		<!--文理科选择-->
		<mt-popup v-model="popuWenli" position="bottom" class="mint-pop-wenli" :closeOnClickModal="false" pop-transition='popup-fade'>
			<mt-picker :slots="classlots" @change="classValuesChange" :showToolbar='true'>
				<span class="mint-datetime-action mint-datetime-cancel" @click="wenliCancle()">取消</span>
				<span class="mint-datetime-action mint-datetime-confirm" @click="wenliConfirm()">确定</span>
			</mt-picker>
		</mt-popup>
		<!--学校的选择-->
		<mt-popup v-model="popupSco" position="bottom" class="mint-pop-popupSco" :closeOnClickModal="false" pop-transition='popup-fade'>
			<mt-picker :slots="choosesco" @change="scoValuesChange" valueKey="text" :showToolbar='true'>
				<span class="mint-datetime-action mint-datetime-cancel" @click="xuexiaoCancle()">取消</span>
				<span class="mint-datetime-action mint-datetime-confirm" @click="xuexiaoConfirm()">确定</span>
			</mt-picker>
		</mt-popup>
		<!--专业的事件-->
		<mt-popup v-model="popupMajor" position="bottom" class="mint-pop-popupMajor" pop-transition='popup-fade' :closeOnClickModal="false" :showToolbar='true'>
			<mt-picker :slots="chooseMajor" @change="MajorValuesChange" :showToolbar='true'>
				<span class="mint-datetime-action mint-datetime-cancel" @click="zhuanyeCancle()">取消</span>
				<span class="mint-datetime-action mint-datetime-confirm" @click="zhuanyeConfirm()">确定</span>
			</mt-picker>
		</mt-popup>
		<!--第一次弹出省份和文理科-->
		<mt-popup v-model="firstPopup" position="middle" class="mint-pop-firstChoose" :closeOnClickModal=false pop-transition='popup-fade'>
			<div id="firstTest">
				...
				<div class="gotest" @click="goNextest">去测算</div>
			</div>
		</mt-popup>
...
<script>
	...
	import { ProvinceData } from "../../../static/scripts/provincedata.js";
