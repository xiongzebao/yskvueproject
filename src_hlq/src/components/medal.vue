						...
						<div class="medal-info">
							<div class="edit-info">
								<form id="formEdit" action="">
									...
									<input type="hidden" value="1319052" id="userID" name="userID">
										<input type="hidden" id="oldCustomName" value="我是sr" class="edit-ipt">
										<div class="edit-info">
											<span class="lorem" v-show="showFlag">
												<span class="names">{{ediT}}</span>
												<span class="edit-icon" v-if="if_Edit" @click="editText"></span>
											</span>
	...
	export default{
		...
		methods:{
			blurE(){
				...
				var upNamep={userID:this.userId,customName:that.ediT}
			...
			loadMedalData(q){
                ...
                if(this.allData.nickName){
                	this.ediT="我是"+this.allData.customName;
                }else{
                	this.ediT="我是"+this.allData.nickName;
                }
